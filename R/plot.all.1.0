#REFERENCE:
#Gelman, A., Carlin, J. B., Stern, H. S., Dunson, D. B., Vehtari, A. & Rubin, D. B. (2014). Bayesian data analysis Third Edition, Chapman and Hall/CRC.
...
file_name = readline(prompt='Please enter excel data file name (without extension): ')
