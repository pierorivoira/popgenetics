...
quadap4 = log(as.numeric(max(countfirst_microsat))) + (0.5*(as.numeric(param_microsat_mod_mod)-mode4)^2)*secondderivativelogpostprob4[which(param_microsat_mod_mod == mode4)]
quadap5 = log(as.numeric(max(count_microsat5))) + (0.5*(as.numeric(param_microsat_mod_mod)-mode5)^2)*secondderivativelogpostprob5[which(param_microsat_mod_mod == mode5)]
quadap6 = log(as.numeric(max(count_microsat6))) + (0.5*(as.numeric(param_microsat_mod_mod)-mode6)^2)*secondderivativelogpostprob6[which(param_microsat_mod_mod == mode6)]
quadap7 = log(as.numeric(max(count_microsat7))) + (0.5*(as.numeric(param_microsat_mod_mod)-mode7)^2)*secondderivativelogpostprob7[which(param_microsat_mod_mod == mode7)]
quadap8 = log(as.numeric(max(count_microsat8))) + (0.5*(as.numeric(param_microsat_mod_mod)-mode8)^2)*secondderivativelogpostprob8[which(param_microsat_mod_mod == mode8)]
quadap9 = log(as.numeric(max(count_microsat9))) + (0.5*(as.numeric(param_microsat_mod_mod)-mode9)^2)*secondderivativelogpostprob9[which(param_microsat_mod_mod == mode9)]


plot(param_microsat_mod_mod, quadap4, type='l',lwd=line_width, col=first_graph_color,xlab="M = m/μ",ylab="quadratic approximation of posterior density",cex.lab=2,cex.axis=2)
lines(param_microsat_mod_mod, quadap5, type='l',lwd=line_width, col=graph_color[1],xlab="M = m/μ",ylab="quadratic approximation of posterior density",cex.lab=2,cex.axis=2)
lines(param_microsat_mod_mod, quadap6, type='l',lwd=line_width, col=graph_color[2],xlab="M = m/μ",ylab="quadratic approximation of posterior density",cex.lab=2,cex.axis=2)
lines(param_microsat_mod_mod, quadap7, type='l',lwd=line_width, col=graph_color[3],xlab="M = m/μ",ylab="quadratic approximation of posterior density",cex.lab=2,cex.axis=2)
lines(param_microsat_mod_mod, quadap8, type='l',lwd=line_width, col=graph_color[4],xlab="M = m/μ",ylab="quadratic approximation of posterior density",cex.lab=2,cex.axis=2)
lines(param_microsat_mod_mod, quadap9, type='l',lwd=line_width, col=graph_color[5],xlab="M = m/μ",ylab="quadratic approximation of posterior density",cex.lab=2,cex.axis=2)
...
{
plot(param_microsat_mod_mod, quadap4, type='l',lwd=line_width, col=first_graph_color,xlab='γ=ΘM=xNeμ*m/μ=xNem',ylab="quadratic approximation of posterior density",cex.lab=2,cex.axis=2)
}
